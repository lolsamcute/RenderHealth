...
<html lang="<?php echo e(config('app.locale')); ?>">
  <head>
    ...
    <?php if(isset($page_type) && ($page_type == 'extra_links' || $page_type == 'health_diary')): ?>
  ...
  <body>
      <nav class="navbar navbar-expand navbar-light navbar_custom">
            ...
            <ul class="navbar-nav navbar_menu">
              <li class="nav-item dropdown profile_link">
                <a class="nav-link dropdown-toggle" href="javascript:;" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <?php endif; ?>
                  Hi, &nbsp; <span class="username"><?php echo e(ucwords($user->patient_first_name)); ?> <?php echo e(ucwords($user->patient_last_name)); ?></span>
                </a>
        ...
        <div class="container-fluid" id="notAllow">
          ...
          <?php if($user): ?>
          <div id="user_login" style="display:none"><?php echo e($user?'true':''); ?></div>
    ...
    <?php endif; ?> 
    <?php if(isset($page_type) && $page_type == 'health_diary'): ?>
      <script src="<?php echo e(asset('js/bootstrap-datepicker.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('js/main.js')); ?>"></script>
      <script src="<?php echo e(asset('js/prettyCheckable.min.js')); ?>"></script>
      <script src="<?php echo e(asset('js/patient_diary.js')); ?>"></script>
    <?php endif; ?>
     <?php if(isset($page_type) && $page_type == 'health_history'): ?>
      <script src="<?php echo e(asset('js/bootstrap-datepicker.js')); ?>" type="text/javascript"></script>
      <script src="<?php echo e(asset('js/main.js')); ?>"></script>
      <script src="<?php echo e(asset('js/prettyCheckable.min.js')); ?>"></script>  
      <script src="<?php echo e(asset('js/patient_history.js')); ?>"></script>   
