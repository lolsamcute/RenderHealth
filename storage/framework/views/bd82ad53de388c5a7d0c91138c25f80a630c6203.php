        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Email</label>
                    <input class="form-control doctor_email" name="doctor_email" placeholder="your email registered" type="text">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Password</label>
                    <input class="form-control doctor_password" name="doctor_password" placeholder="your password" type="password">
                </div>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('layouts.admin_login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>