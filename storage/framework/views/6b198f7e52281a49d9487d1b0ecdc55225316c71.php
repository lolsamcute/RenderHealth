        ...
        <div class="row">
            <div class="col-12">
                <div class="page_head">
                    ...
                    <div>
                       <a href="<?php echo e(url('admin/add_new_record/'.$patient_detail['patient_unique_id'])); ?>" class="btn btn-primary btn-sm btn-medical">Add Medical Record</a> 
                       <!--  <?php if(isset($health_his->doctor->access_to_hospital) && ($health_his->doctor->access_to_hospital == 1 || $health_his->doctor->access_to_hospital == 3)): ?> -->
                         
                        <!-- <?php else: ?>
                      <a href="<?php echo e(url('doctor/add_new_record/'.$patient_detail['patient_unique_id'])); ?>" class="btn btn-primary btn-sm btn-medical disabled">Add Medical Record</a> 
                        <?php endif; ?> -->
...
<?php //echo "<pre>";print_r($health_history);?>
                                        ...
                                        <a href="<?php echo e(url('admin/view_record/'.$health_his->history_id)); ?>" class="btn btn-light btn-xs mr-2" name="button"><img class="icon" src="<?php echo e(asset('admin/doctor/images/eye.svg')); ?>" alt="icon">View Detail</a>
                                         <div class="dropdown d-inline-block">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                              ...
                                              <a class="dropdown-item" href="<?php echo e(url('admin/add_new_record/'.$patient_detail['patient_unique_id'])); ?>"><span><img src="<?php echo e(asset('admin/doctor/images/enter.svg')); ?>" alt="icon"></span>Enter Record</a>
