						...
						<td>
							...
							<?php else: ?>
								<?php if($appointment['booking_id'] != ""): ?>
									<a href="<?php echo e(url('doctor/appointment_detail/'.$appointment['booking_id'])); ?>" class="btn btn-light btn-xs mr-2" name="button"><img class="icon" src="<?php echo e(asset('admin/doctor/images/eye.svg')); ?>" alt="">View</a>
								<?php else: ?>
									<a href="javascript:;" class="btn btn-light btn-xs mr-2" name="button"><img class="icon" src="<?php echo e(asset('admin/doctor/images/eye.svg')); ?>" alt="">View</a>
								<?php endif; ?>
							<?php endif; ?>
						   	...
						   	<div class="dropdown d-inline-block">
								...
								<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
									<div class="sure">
										...
										<button type="button" class="btn btn-light btn-xs mr-2" onclick="cancelBooking(this); return false;"  data-patient_id="<?php echo e($appointment['patient_id']); ?>" data-booking_id="<?php echo e($appointment['booking_id']); ?>">Yes, I am Sure</button>
                     ...
                     <div id="hostpital_appointment" class="tab-pane fade show active">
						<form id="hosp_form">
							 <div class="consult_detail">
								 ...
								 <div class="picker">
									 <div class=" mb-2 availability_date" id="date1" data-date="<?php echo e(date('d F Y')); ?>" data-date-format="dd-mm-yyyy"></div>
											...
											<div class="select_box">																 	
												 	<select class="form-control start_time" name="hosp_start_time">											 	
													 		...
													 		foreach($array as $key=>$single){ ?>
													 			<option value='<?php echo e(date("H:i",strtotime($key))); ?>' <?php if(date("H:i",strtotime($key)) < date("H:i",strtotime("now"))){ ?>disabled <?php } ?>><?php echo e($single); ?></option>
													 	<?php 	} ?>
