...
<form class="form-signin" action="" method="POST" onsubmit="doctorLogin(this); return false;">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Email</label>
                    <input class="form-control employee_email" name="employee_email" placeholder="your email registered" type="text">
                </div>
            </div>
            <div class="col-sm-12">
                <div class="form-group">
                    <label>Password</label>
                    <input class="form-control employee_password" name="employee_password" placeholder="your password" type="password">
                </div>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('layouts.employee_login', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>