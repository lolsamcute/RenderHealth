  ...
  <head>
    ...
    <div class="loading">Loading&#8230;</div>
        <nav class="navbar navbar-expand navbar-light navbar_custom">
            ...
            <a class="navbar-brand" href="<?php echo e(url('/doctor/dashboard')); ?>"><img src="<?php echo e(asset('admin/doctor/images/render_logo_white.svg')); ?>" alt="logo"/></a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="header_search my-2 my-lg-0 mr-auto">
                    <div class="notify">
                       Hi, <?php echo e($doctor_details->doctor_first_name); ?>. You’ve <b><?php if(isset($today_appointments_count) && $today_appointments_count > 0): ?><?php echo e($today_appointments_count); ?><?php else: ?> <?php echo e("0"); ?><?php endif; ?> appointments today</b>
                   </div>
                </div>
                <ul class="navbar-nav navbar_menu">
                    ...
                    <li class="nav-item dropdown profile_link">
                        ...
                        <?php 
                        if(!empty($doctor_details->doctor_picture)){
                        if(file_exists(getcwd().'/doctorimages/'.$doctor_details->doctor_picture)){
                        $picture=$doctor_details->doctor_picture;
                        }
                        else {
                        $picture=$doctor_details->doctor_picture;
                        } } 
                        ...
                        $picture=$doctor_details->doctor_picture;
                            ...
                            <span class="profile_image" style="background-image:url(<?php echo e(asset('/doctorimages/'.$picture)); ?>);"></span>
                            Hi, &nbsp; <span class="username"><?php echo e($doctor_details->doctor_title); ?> <?php echo e($doctor_details->doctor_first_name); ?> <?php echo e($doctor_details->doctor_last_name); ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('doctor/logout')); ?>"><span><img src="<?php echo e(asset('admin/doctor/images/logout.svg')); ?>" alt="icon"></span>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
        </nav>
    <?php if(isset($page_type) && $page_type == 'appoint_search'): ?>
        <div class="container">
    <?php else: ?>        
    ...
    <?php endif; ?>
            <div class="row flex-xl-nowrap">
                <div class="bd-sidebar">
                    <div class="main_menu">
                        ...
                        <ul>
                            <li id="act" class="<?php echo Request::is('doctor/hospital_appoinment') ? 'active' : '' ?>">
                                <a href="<?php echo e(url('doctor/hospital_appoinment')); ?>" class="<?php if(($doctor_details->appointment_access==0)){ echo 'disabled_cancel'; } ?>">
                            ...
                            <li id="act1">
                                <a href="<?php echo e(url('doctor/telemedical_appoinment')); ?>" class="<?php if(($doctor_details->teleconsulation_access==0)){ echo 'disabled_cancel'; } ?>">
                                    <div class="icon_main">
                        ...
                        <ul>
                            ...
                            <li id="act2" class="<?php echo Request::is('doctor/patients*') ? 'active' : '' ?>">
                                <a href="<?php echo e(url('/doctor/patients')); ?>" class="<?php if(($doctor_details->patient_queue_access==0)){ echo 'disabled_cancel'; } ?>">
                                    <div class="icon_main">
                            ...
                            <li>
                                <a class="collapsed has_submenu <?php if(($doctor_details->billings_access==0)){ echo 'disabled_cancel'; } ?>" href="javascript:;" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <div class="icon_main has_notification">
                                        <svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <defs></defs>
                                            <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <div id="collapseOne" class="collapse">
                                    <ul class="submenu">
                                        <li id="act3" class="<?php echo Request::is('/doctor/view_all_billings*') ? 'active' : '' ?>">
                                            <a href="<?php echo e(url('/doctor/view_all_billings')); ?>" class="<?php if(($doctor_details->billings_access==0)){ echo 'disabled_cancel'; } ?>">View All Bilings</a>
                                        </li>
                                        <li id="act4" class="<?php echo Request::is('doctor/dispute_billings*') ? 'active' : '' ?>">
                                            <a href="<?php echo e(url('/doctor/dispute_billings')); ?>" class="<?php if(($doctor_details->billings_access==0)){ echo 'disabled_cancel'; } ?>">Disputed Billings <span class="sub_counter"><?php if(isset($disputed_billing_count)): ?><?php echo e($disputed_billing_count); ?> <?php else: ?> 0 <?php endif; ?></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li id="act6" class="<?php echo Request::is('/doctor/settings/') ? 'active' : '' ?>">
                                <a href="<?php echo e(url('/doctor/settings')); ?>">
                                    <div class="icon_main">
                                        <svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <defs></defs>
                                            <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <script src="<?php echo e(asset('admin/doctor/js/bootstrap-datepicker.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset('admin/doctor/js/prettyCheckable.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin/doctor/js/main.js')); ?>"></script>
        <script src="<?php echo e(asset('admin/doctor/customjs/setup.js')); ?>"></script>
        ...
        <?php if(!isset($page_type) || (isset($page_type) && $page_type != 'health_history')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/doctor_dashboard.js')); ?>"></script>
        <?php endif; ?>       
        <?php if(isset($page_type) && ($page_type == 'time_count' || $page_type == 'appointments')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/first.js')); ?>"></script>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/appointments.js')); ?>"></script>
        <?php endif; ?> 

        <?php if(isset($page_type) && ($page_type == 'search' || $page_type == 'appoint_search')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/first.js')); ?>"></script>            
        <?php endif; ?> 
        <?php if(isset($page_type) && ($page_type == 'health_history')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/doctor_history_main.js')); ?>"></script>
        <?php endif; ?>  
        <?php if(isset($page_type) && ($page_type == 'settings')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/doctor_settings.js')); ?>"></script>
        <?php endif; ?>
        <?php if(isset($page_type) && ($page_type == 'billing')): ?>
            <script src="https://js.paystack.co/v1/inline.js"></script>
            <script type="text/javascript"  src="<?php echo e(asset('admin/doctor/js/doctor_billings.js')); ?>"></script>
        <?php endif; ?>  
        ...
        <script type="text/javascript">
            ...
            if(window.location.href.indexOf("view_all_billings") > -1 || window.location.href.indexOf("billing_detail") > -1){
                $('.main_menu ul li ').removeClass('active');
                if(window.location.href.indexOf("view_all_billings") > -1){
                    $("#act3").addClass('active');
                }
                if(window.location.href.indexOf("billing_detail") > -1){
