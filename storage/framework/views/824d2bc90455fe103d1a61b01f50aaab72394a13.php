...
<main class="col-12 col-md-12 col-xl-12 bd-content">
	<div class="doctor_div">
		<div class="row">
			<div class="col-12">
				<div class="page_head">
					<h5 class="heading">Appointments of <?php echo e($doctor_details->doctor_first_name); ?> <?php echo e($doctor_details->doctor_last_name); ?> 
					...
					<div class="select_box select_box_heading">
					  	<select class="appointment_time form-control" onclick="sortDoctorAppointments(this);">
		...
		<div class="row">
			<div class="col-12">						  
				...
				<div id="all_appointments" class="main_div">
