        ...
        <div class="col-12 main_div">
            <div class="table_hospital pagination_fixed_bottom">
                    ...
                    <table class="table" cellspacing="10">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(url('/doctor/patients/medical_records/'.$all_patient['patient_unique_id'])); ?>" class="<?php if(($doctor_details->health_record_access==0)){ echo 'disabled_cancel'; } ?> btn btn-light btn-xs mr-2" name="button"><img class="icon" src="<?php echo e(asset('admin/adminimages/eye.svg')); ?>" alt="icon">View Record(s)</a>
                            </td>
                        </tr>
                ...
                <div class="table_pagination">
                    <button type="button" class="btn btn-light btn-xs pre_patient" 
                        <?php if ($all_patients->previousPageUrl()) {
                        } else {
                            echo "disabled";
                        } ?> data-url="<?php echo $all_patients->previousPageUrl(); ?>&type=mem_page">Previous Page
                    </button>
                    ...
                    <button type="button" class="btn btn-light btn-xs next_patient" 
                        <?php if ($all_patients->nextPageUrl()) {
                        } else {
                            echo "disabled";
                        } ?> data-url="<?php echo $all_patients->nextPageUrl(); ?>&type=mem_page">Next Page
                    </button>
                </div>
            </div>
        </div>
                ...
                <form id="search_patient_form" name="search_patient_form" method="GET">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <button type="submit" class="btn btn-primary mb-3 mt-3">Search Patient</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered genmodal genmodal_custom custom_width3">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="addPatient" name="addPatient" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label>First name</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control patient_blood_type" name="patient_blood_type" id="patient_blood_type">
