               ...
               <td>
                   <div class="d_profile">
                       ...
                       <div class="d_pro_text">
                           <h4><?php if($all_patient['patient_gender']== 0 && $all_patient['patient_gender']!= NULL): ?> Mr. <?php elseif($all_patient['patient_gender']== 1 && $all_patient['patient_martial_status']== 1): ?>Mrs                               <?php elseif($all_patient['patient_gender']== 1): ?> Miss
                                       <?php else: ?> <?php endif; ?>  <?php echo e($all_patient['patient_first_name']); ?> <?php echo e($all_patient['patient_last_name']); ?></h4>
                           <a href="javascript:;">View Profile</a>
                       </div>
                   </div>
               </td>
               <td>PATIENT-<?php echo e($all_patient['patient_unique_id']); ?></td>
               <td><?php echo e(date('d M, Y',$all_patient['patient_date_of_birth'])); ?></td>
               <td><?php echo e($all_patient['patient_insurance']); ?></td>
               <td><?php echo e(date('d M, Y',$all_patient['patient_end_subscription'])); ?></td>
                <td>
