...
<head>
    ...
    <script src="//code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
     <script type="text/javascript"  src="<?php echo e(asset('admin/adminjs/admin_dashboard.js')); ?>"></script>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav navbar_menu">
                ...
                <li class="nav-item dropdown profile_link">
                    ...
                    <?php if(isset($admin_details->employee_picture) && $admin_details->employee_picture!=''): ?><span class="profile_image" style="background-image:url(<?php echo e(asset('employeeimages/'.$admin_details->employee_picture)); ?>);"></span><?php else: ?> <span class="profile_image" style="background-image:url(<?php echo e(asset('admin/adminimages/profile.svg')); ?>);"></span> <?php endif; ?>
                ...
                <div class="main_menu">
                    ...
                    <ul>
                        <li class="active">
                            ...
                            <div id="collapseTwo" class="collapse <?php echo e((url('/admin/dashboard') == Request::url()) || (url('/admin/all_hospitals') == Request::url()) || (url('/admin/all_employees') == Request::url())  || (url('/admin/all_doctors') == Request::url()) || (url('/admin/deals') == Request::url()) ? 'show' : ''); ?>">
                                <ul class="submenu" id="sidebar_menu">
                                    <li id="option_1">
                                        <a href="<?php echo e(url('/admin/dashboard')); ?>">Members/Patient</a>
                                    </li>
                                    <li id="option_2">
                                        <a href="<?php echo e(url('/admin/all_hospitals')); ?>">Hospitals/Labs</a>
                                    </li>
                                    <li id="option_3">
                                        <a href="javascript:void(0)">HMO</a>
                                    </li>
                                    <?php if(isset($admin_details) && $admin_details->role_type!='employee'): ?>
                                    <li id="option_4">
                                        <a href="<?php echo e(url('/admin/all_employees')); ?>">Render Employees</a>
                                    </li>
                                    <?php endif; ?>
                                    <li id="option_5">
                                        <a href="<?php echo e(url('/admin/all_doctors')); ?>">Doctors</a>
                                    </li>
                                    <li id="option_6">
                                        <a href="<?php echo e(url('/admin/deals')); ?>">Deals</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="">
                            <a href="<?php echo e(url('/admin/health-record')); ?>">
                                <div class="icon_main">
                    ...
                    <ul>
                       ...
                       <li>
                            <a href="<?php echo e(url('/admin/search_patient')); ?>">
                                <div class="icon_main">
                        ...
                        <li>
                            ...
                            <div id="collapseOne" class="collapse">
                                <ul class="submenu">
                                    <li>
                                        <a href="<?php echo e(url('/admin/view_doctors_billing')); ?>">View All Bilings</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/admin/view_hospital_billing')); ?>">Billings by Hospital</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('/admin/view_disputes_billing')); ?>">Disputed Billings <span class="sub_counter"><?php if(isset($disputed_billing_count)): ?> <?php echo e($disputed_billing_count); ?> <?php else: ?> <?php echo e(0); ?> <?php endif; ?></span></a>
                                    </li>
                                </ul>
                            </div>
                        </li>
