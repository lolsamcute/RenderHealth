    ...
    <div class="row">
        <div class="col-12">
            <div class="widget padding-40">  
                ...
                <?php echo Form::open(array('url' => 'doctor/patient_search_result','method' => 'get','id'=>'got')); ?>
                   ...
                   <?php echo e(csrf_field()); ?>                
                    ...
                    <div class="row">                   
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Surname</label>
                                        <input name="surename" class="form-control" id="surename" type="text">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                       ...
                       <div class="col-sm-12"><div class="text-center">---OR---</div></div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label data-toggle="tooltip" data-placement="top" title="You also can search by Patient ID for fastest way">Patient ID</label>
                                <input  name="medical_record" class="form-control" id="medical_record"  type="text">
                            </div>
                        </div>
