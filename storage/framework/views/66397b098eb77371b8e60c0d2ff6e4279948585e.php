...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('admin/employee/css/datepicker.css')); ?>" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(asset('admin/employee/css/prettyCheckable.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/employee/css/style.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin/employee/css/developer.css')); ?>" rel="stylesheet">
    <!--   date piker -->
    ...
    <body class="slide_left">
        <nav class="navbar navbar-expand navbar-light navbar_custom">
            ...
            <a class="navbar-brand" href="<?php echo e(url('/employee/dashboard')); ?>"><img src="<?php echo e(asset('admin/doctor/images/render_logo_white.svg')); ?>" alt="logo"/></a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <div class="header_search my-2 my-lg-0 mr-auto">
                    <div class="notify">
                       Hi, <?php echo e($employee_details->employee_first_name); ?>. You’ve <b><?php if(isset($today_appointments_count) && $today_appointments_count > 0): ?><?php echo e($today_appointments_count); ?><?php else: ?> <?php echo e("0"); ?><?php endif; ?> appointments today</b>
                   </div>
                </div>
                <ul class="navbar-nav navbar_menu">
                    ...
                    <li class="nav-item dropdown profile_link">
                        <a class="nav-link dropdown-toggle" href="javascript:;" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="profile_image" style="background-image:url(<?php echo e(asset('admin/employee/uploads/profile/'.$employee_details->employee_picture)); ?>);"></span>
                            Hi, &nbsp; <span class="username"><?php echo e($employee_details->employee_title); ?> <?php echo e($employee_details->employee_first_name); ?> <?php echo e($employee_details->employee_last_name); ?></span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo e(url('employee/logout')); ?>"><span><img src="<?php echo e(asset('admin/doctor/images/logout.svg')); ?>" alt="icon"></span>Logout</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="row flex-xl-nowrap">
                <div class="bd-sidebar">
                    <div class="main_menu">
                        ...
                        <ul>
                            <li id="act">
                                <a href="<?php echo e(url('/employee/all_appointments')); ?>">
                            ...
                            <li id="act1">
                                <a href="<?php echo e(url('employee/telemedical_appoinment')); ?>">
                                    <div class="icon_main">
                        ...
                        <ul>
                            <li id="act2">
                                <a href="<?php echo e(url('/employee/search_patient')); ?>">
                                    <div class="icon_main">
                            ...
                            <li id="act3">
                                ...
                                <div id="collapseOne" class="collapse">
                                    <ul class="submenu">
                                        <li id="act4">
                                            <a href="<?php echo e(url('/employee/view_all_billings')); ?>" class="<?php if(isset($employee_details->access_to_hospital) && ($employee_details->access_to_hospital != 2 && $employee_details->access_to_hospital != 3)){ echo 'disabled_cancel'; } ?>">View All Bilings</a>
                                        </li>
                                        <li>
                                            <a href="javascript:;" class="<?php if(isset($employee_details->access_to_hospital) && ($employee_details->access_to_hospital != 2 && $employee_details->access_to_hospital != 3)){ echo 'disabled_cancel'; } ?>">Billings by Hospital</a>
                                        </li>
                                        <li id="act5">
                                            <a href="<?php echo e(url('/employee/dispute_billings')); ?>" class="<?php if(isset($employee_details->access_to_hospital) && ($employee_details->access_to_hospital != 2 && $employee_details->access_to_hospital != 3)){ echo 'disabled_cancel'; } ?>">Disputed Billings <span class="sub_counter">2</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li id="act6">
                                <a href="<?php echo e(url('/employee/settings')); ?>">
                                    <div class="icon_main">
                                        <svg width="18px" height="18px" viewBox="0 0 18 18" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <defs></defs>
                                            <g id="Symbols" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <script src="<?php echo e(asset('admin/employee/js/bootstrap-datepicker.js')); ?>" type="text/javascript"></script>
        <script src="<?php echo e(asset('admin/employee/js/prettyCheckable.min.js')); ?>"></script>
        <script src="<?php echo e(asset('admin/employee/js/main.js')); ?>"></script>
        <script src="<?php echo e(asset('admin/employee/customjs/setup.js')); ?>"></script>
        ...
        <?php if(!isset($page_type) || (isset($page_type) && $page_type != 'health_history')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/employee/js/employee_dashboard.js')); ?>"></script>
        <?php endif; ?>       
        <?php if(isset($page_type) && ($page_type == 'time_count' || $page_type == 'appointments')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/employee/js/first.js')); ?>"></script>            
        <?php endif; ?> 
        <?php if(isset($page_type) && ($page_type == 'health_history')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/employee/js/employee_history_main.js')); ?>"></script>
        <?php endif; ?>  
        <?php if(isset($page_type) && ($page_type == 'settings')): ?>
            <script type="text/javascript"  src="<?php echo e(asset('admin/employee/js/employee_settings.js')); ?>"></script>
        <?php endif; ?>
        <?php if(isset($page_type) && ($page_type == 'billing')): ?>
            <script src="https://js.paystack.co/v1/inline.js"></script>
            <script type="text/javascript"  src="<?php echo e(asset('admin/employee/js/employee_billings.js')); ?>"></script>
        <?php endif; ?>    
